...
// ---------- История проекта из PR и идеи (26.09) ----------
// Каждый пункт — одна законченная вещь с датой мержа и ссылками на PR. Если такая задача уже была в трекере
// (match — её название), она не дублируется: закрывается и получает ссылки на PR и комментарий с датой.
const PR = (n) => ({ kind: "url", url: `https://github.com/oxionezhkov-hub/helpmedoctor/pull/${n}`, label: `PR #${n}` });
const HISTORY_LABEL = "история";
const PROJECT_HISTORY = [
  { date: "2026-09-24T14:35:39Z", prs: [1, 2], type: "bug", title: "Исправления по отзыву тестировщика, плавная плашка ожидания", descr: "Ожидание ответа ИИ — ровная полоса без мерцания и скачков; правки по первому тестированию бота." },
  { date: "2026-09-25T10:47:27Z", prs: [2, 5], match: "Стартовый вопрос в боте: кто пользователь и какая специальность", note: "Анкета при первом входе (роль, специальность, разделы, сложность) и сразу первый пациент под профиль." },
  { date: "2026-09-25T06:53:33Z", prs: [3], type: "feature", title: "Команда /grant, второй админ, пациенты без «инопланетян», исправление оплаты", descr: "Выдача премиума командой /grant @username N, Саша — второй админ, убраны шуточные пациенты-инопланетяне." },
  { date: "2026-09-25T10:12:34Z", prs: [4], match: "Дашборд с аналитикой и общий трекер задач", note: "Админка /admin: аналитика, пользователи, переписка, подписки, рассылки, задачи." },
  { date: "2026-09-25T10:47:27Z", prs: [5], match: "Иероглифы / китайские символы в ответах ИИ на русском", note: "Чистка чужих письменностей в ответах ИИ и распознавании речи." },
  { date: "2026-09-25T10:47:27Z", prs: [5], type: "feature", title: "Эндоскопия — отдельный метод обследования, вход на сайт без новой вкладки", descr: "ФГДС, колоноскопия, бронхоскопия больше не смешиваются с УЗИ/КТ; вход через бота открывает сайт в той же вкладке." },
  { date: "2026-09-25T16:34:18Z", prs: [5, 18], type: "feature", title: "Оплата через Точку: посредник в Yandex Cloud, подписки с автопродлением", descr: "Cloudflare не доверяет сертификату Точки — запросы идут через функцию в Yandex Cloud; выкладка функции через GitHub Actions." },
  { date: "2026-09-25T13:42:30Z", prs: [6, 7, 8, 9, 10, 11], match: "Купить домен и запустить SEO через статьи", note: "helpmedoctor.ru через прокси на VPS (в РФ режут Cloudflare), главная, блог, sitemap, IndexNow, Яндекс Метрика." },
  { date: "2026-09-25T14:02:58Z", prs: [12], match: "Запасной ИИ и модели по шагам", note: "Qwen3 по умолчанию, модели по шагам в админке, запасной ИИ Cerebras/Groq." },
  { date: "2026-09-25T15:03:05Z", prs: [13], match: "Новая главная и профиль", note: "Вместе с этим PR: отзыв после разбора, аватар, удаление пациентов и тестов, анимации диалога." },
  { date: "2026-09-25T15:44:24Z", prs: [14, 15, 16], type: "feature", title: "Лица пациентов (Open Peeps) и обложки статей блога", descr: "Рисованные лица по полу, возрасту и самочувствию; спокойные выражения, естественные цвета волос; обложки и OG-картинки статей." },
  { date: "2026-09-25T17:05:52Z", prs: [17, 20], match: "Продумать монетизацию и подписку", note: "Пробный премиум 7 дней за 1 ₽ с автопродлением, тарифы с ранними ценами, премиум-функции, разовые покупки (+3 пациента, заморозка стрика), оплата внутри приложения." },
  { date: "2026-09-25T16:39:31Z", prs: [19], type: "org", title: "Оферта и политика конфиденциальности, правки мини-приложения", descr: "Публичная оферта, политика обработки ПДн, согласие на автосписания при оплате." },
  { date: "2026-09-25T17:05:52Z", prs: [20], type: "feature", title: "Оценка приёма по формуле", descr: "ИИ ставит баллы по осям (диагностика, лечение, общение) по якорям, итог считает формула с «потолками» за неверный диагноз и опасную ошибку — одинаковые приёмы получают одинаковые оценки." },
  { date: "2026-09-26T06:12:36Z", prs: [20, 21, 25, 26], type: "content", title: "Блог: 11 статей под поисковые запросы и ежедневная рутина", descr: "ЭКГ, биохимия, ОАМ, газы крови, коагулограмма, рентген лёгких и 5 базовых статей. Рутина публикует статью каждый день; после SEO-аудита — правила против шаблонности (стоп-фразы, уникальность, E-E-A-T) и очередь обновления старых статей." },
  { date: "2026-09-25T19:22:23Z", prs: [22], match: "Три посадочные страницы: кардиология, терапия, неврология", note: "Сделано шире: 10 страниц специальностей, посадочные для студентов, ординаторов и врачей, аккредитация, клинические задачи." },
  { date: "2026-09-25T19:22:23Z", prs: [22], type: "feature", title: "Вход через Google и Яндекс с привязкой Telegram", descr: "Веб-аккаунт без Telegram; позже Telegram привязывается в «Способах входа», данные складываются." },
  { date: "2026-09-25T20:13:31Z", prs: [22, 23, 24], type: "marketing", title: "Новый сайт: демо-приём без регистрации, конверсионные блоки", descr: "Дизайн без «ИИ-вида», демо-приём, липкая кнопка, окно при уходе, CTA в статьях; чистый первый экран, тарифы с преимуществами." },
  { date: "2026-09-25T19:22:23Z", prs: [22], type: "content", title: "Материалы для Telegram-канала: подборка ресурсов и PDF-чек-лист", descr: "content/telegram-channel: ресурсы с описаниями и чек-лист «Сбор анамнеза за 10 минут» в фирменном PDF." },
  { date: "2026-09-26T06:12:36Z", prs: [26], type: "feature", title: "Тёмная тема, пациент-всплывашка на сайте, поддержка @oleg_ezhkov", descr: "Переключатель темы с запоминанием, клинический случай в углу сайта с таймером, контакт поддержки на сайте и в приложении." },
  { date: "2026-09-26T09:22:08Z", prs: [27], type: "feature", status: "review", title: "Подсказки на приёме, разбор и тесты по КР Минздрава", descr: "Три подсказки наставника на пациента (−0,2 к оценке каждая); разбор по тексту действующей КР из рубрикатора: чек-лист, диагностика, препараты и дозы; тесты с упором на лечение и диагностику. После мержа — перенести в «Готово»." },
];

const IDEAS_0926 = [
  { title: "Telegram-канал + Дзен: контент-воронка с автопостингом", type: "marketing", priority: "high", descr: `Зачем: бесплатная органика от студентов-медиков в тренажёр.
Как устроено:
• База — Telegram-канал. Посты публикует наш бот (Bot API); готовить пост каждый день может рутина Claude.
• Дзен забирает посты из Telegram сам: в студии Дзена подключается импорт канала через бота (официальный способ, открытого API у Дзена нет). Лента рекомендаций Дзена даёт охват даже без подписчиков.
• ВК (клипы и посты) — через VK API или SMMplanner / Postmypost (~1200 ₽/мес, одно окно для ВК, TG, Дзена, OK, TenChat, YouTube, Rutube).
• Пикабу, форумы, чаты вузов — только вручную и без ссылки в первом сообщении, иначе бан.
Темы — боль студента, а не теория: «как студенту-медику не загнуться к 4 курсу», «нет практики — иди сюда», «первый самостоятельный пациент: что идёт не так», «станция анамнеза: за что снимают баллы», «пациент говорит… твой первый вопрос?» (опрос, ответ завтра), «угадай диагноз по трём фразам», «обязательная отработка после вуза», юмор с нашими пациентами-персонажами.
Готово: content/telegram-channel — подборка ресурсов и PDF-чек-лист.
Нужно от нас: создать канал, добавить бота админом, прислать ID канала и токен сообщества ВК — тогда собрать рутину автопостинга.
Метрики: подписчики, переходы /app?from=tg и from=dzen, регистрации.` },
  { title: "Вести Telegram и Дзен от лица выдуманной студентки-медика", type: "marketing", priority: "high", descr: `Зачем: личный голос вовлекает сильнее бренда — студенты подписываются на «свою».
Персона (черновик): Аня, 5 курс лечфака, готовится к аккредитации; пишет про учёбу, дежурства, провалы и лайфхаки. Тренажёр — её инструмент, а не реклама: упоминание примерно в каждом 4–5-м посте.
Рубрики: «разбор моей ошибки», «пациент дня», «как я готовлюсь», опросы и «угадай диагноз».
Оформление: аватар в стиле наших лиц Open Peeps, единый тон, без реального вуза.
Честность: в описании канала указать, что это персонаж проекта Help me, Doctor. Выдавать вымышленного человека за реального и давать от её имени медицинские советы нельзя — и репутационно, и по закону о рекламе.
Решить: имя, внешность, курс, город; кто утверждает посты.` },
  { title: "Сценарии рилсов и клипов — снимаем сами", type: "content", priority: "medium", descr: `Площадки: VK Клипы (главная органика у студентов-медиков), YouTube Shorts, ролики в Дзене; Reels — по желанию.
Форматы 20–45 секунд:
1. «Пациент говорит… а ты что спросишь?» — фраза на экране, пауза 3 с, верный вопрос и почему, в конце «потренируйся на таких».
2. «Угадай диагноз за 3 подсказки»: жалоба → анамнез → анализ, ответ в конце или в комментариях.
3. «Ошибка, за которую снимают баллы на аккредитации».
4. Запись экрана тренажёра: приём за 30 секунд и оценка.
5. Юмор: «пациенты, которые приходят к каждому врачу».
6. «Так / не так»: как не надо и как надо спросить.
Производство: хук в первые 2 секунды, одна мысль на ролик, субтитры, вертикаль 9:16; снимаем на телефон, озвучиваем сами; 3 ролика в неделю.
Следующий шаг: Claude пишет 10 сценариев с раскадровкой и текстом субтитров → выбираем и снимаем пилотные 3.` },
  { title: "Картинки для каруселей (Instagram и ВК)", type: "content", priority: "medium", descr: `Формат: 5–8 слайдов 1080×1350 в стиле сайта — бумага, шрифт Literata, зелёный и красный акценты, лица Open Peeps.
Темы: «Сбор анамнеза за 10 минут» (из PDF-чек-листа), «ОАК: что смотреть первым», «5 ошибок на станции анамнеза», «Красные флаги боли в груди», «Схема лечения по КР: язвенная болезнь» (из разборов тренажёра), клинический случай «что бы вы сделали?» с ответом на последнем слайде.
Как делать: HTML-шаблон → PNG, как обложки блога (scripts/build-images.mjs) — Claude генерирует пачку автоматически.
Важно: Meta (Instagram) в РФ признана экстремистской организацией — реклама и ссылки там рискованны. Основное место для каруселей — ВК (посты-карусели) и альбомы в Telegram; Instagram — вторично.` },
];

function runHistoryImport(h) {
  const key = "task_import:history_0926";
  if (h.getMeta(key)) return;
  const now = Date.now();
  h.setMeta(key, now);
  PROJECT_HISTORY.forEach((it, i) => {
    const ts = Date.parse(it.date);
    const links = it.prs.map(PR);
    const prText = it.prs.map((n) => `#${n}`).join(", ");
    const day = new Date(ts).toLocaleDateString("ru", { day: "numeric", month: "long", timeZone: "Europe/Moscow" });
    const found = it.match && h.one("SELECT id, status, links FROM tasks WHERE title = ? ORDER BY id LIMIT 1", it.match);
    if (found) {
      let old = [];
      try { old = JSON.parse(found.links || "[]"); } catch {}
      const merged = [...old, ...links.filter((l) => !old.some((o) => o.url === l.url))];
      h.sql.exec("UPDATE tasks SET status = 'done', links = ?, updated_at = ?, done_at = ? WHERE id = ?", JSON.stringify(merged), ts, ts, found.id);
      if (found.status !== "done") h.sql.exec("INSERT INTO task_history (task_id, ts, admin, field, old, new) VALUES (?, ?, 'system', 'status', ?, 'done')", found.id, now, found.status);
      h.sql.exec("INSERT INTO task_comments (task_id, ts, admin, text) VALUES (?, ?, 'system', ?)", found.id, now, `✅ ${day}, PR ${prText}. ${it.note || ""}`.trim());
      return;
    }
    if (!it.title || h.one("SELECT id FROM tasks WHERE title = ? LIMIT 1", it.title)) return;
    h.sql.exec(
      "INSERT INTO tasks (title, descr, type, status, priority, assignee, labels, links, checklist, created_by, created_at, updated_at, done_at, sort) VALUES (?, ?, ?, ?, 'medium', ?, ?, ?, '[]', 'system', ?, ?, ?, ?)",
      it.title, `${it.descr}\n\n${day} · PR ${prText}`, it.type, it.status || "done", OLEG, JSON.stringify([HISTORY_LABEL]), JSON.stringify(links), ts, ts, (it.status || "done") === "done" ? ts : null, -3000 + i,
    );
  });
  IDEAS_0926.forEach((t, i) => {
    if (h.one("SELECT id FROM tasks WHERE title = ? LIMIT 1", t.title)) return;
    h.sql.exec(
      "INSERT INTO tasks (title, descr, type, status, priority, labels, links, checklist, created_by, created_at, updated_at, sort) VALUES (?, ?, ?, 'idea', ?, ?, '[]', '[]', 'system', ?, ?, ?)",
      t.title, t.descr, t.type, t.priority, JSON.stringify(["маркетинг 26.09"]), now, now, -4000 + i,
    );
  });
}
...
async function taskUpdate(h, { id, patch }, admin) {
  ...
  // Дата закрытия — для «Истории»: ставится при переходе в «Готово», снимается при возврате
  if (cols.includes("status")) h.sql.exec("UPDATE tasks SET done_at = ? WHERE id = ?", t.status === "done" ? Date.now() : null, cur.id);
